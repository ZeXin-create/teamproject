...
import { Zap, Target, Users, BarChart3, Trophy } from 'lucide-react'
              ...
              >
                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <Link href="/group" className="card card-hover block">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h3 className="font-semibold text-gray-800">智能分组</h3>
                          <p className="text-sm text-gray-600">基于数据自动分组</p>
                        </div>
                      </div>
                    </Link>
                    <Link href="/teams/manage" className="card card-hover block">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h3 className="font-semibold text-gray-800">成员管理</h3>
                          <p className="text-sm text-gray-600">管理战队成员</p>
                        </div>
                      </div>
                    </Link>
                    <Link href="/teams/data/analytics" className="card card-hover block">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">战队数据分析</p>
                        </div>
                      </div>
                    </Link>
                    <Link href="/teams/data/match-records" className="card card-hover block">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-full bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center text-white">
                          <Trophy className="w-6 h-6" />
                        </div>
                        <div>
                          <h3 className="font-semibold text-gray-800">比赛记录</h3>
                          <p className="text-sm text-gray-600">查看和管理比赛</p>
                        </div>
                      </div>
                    </Link>
                  </div>
