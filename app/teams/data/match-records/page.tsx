      ...
      <div className="container mx-auto px-4 pt-24 md:pt-28 pb-8">
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-6 shadow-lg shadow-pink-100/50 border border-white/60 hover:scale-105 transition-transform duration-300">
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-6 shadow-lg shadow-green-100/50 border border-white/60 hover:scale-105 transition-transform duration-300">
              <div className="flex items-center gap-3 mb-2">
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-6 shadow-lg shadow-red-100/50 border border-white/60 hover:scale-105 transition-transform duration-300">
              <div className="flex items-center gap-3 mb-2">
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-6 shadow-lg shadow-purple-100/50 border border-white/60 hover:scale-105 transition-transform duration-300">
              <div className="flex items-center gap-3 mb-2">
                        ...
                        {hasMatchRecordPermission() && (
                          <>
                            <button
                              ...
                              className="px-5 py-2 text-sm font-medium bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all duration-300 shadow-sm"
                            >
                              ✏️ 编辑
                            </button>
                            <button
                              onClick={() => handleDeleteRecord(record.id || '')}
                              className="px-5 py-2 text-sm font-medium bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl hover:from-red-600 hover:to-red-700 transition-all duration-300 shadow-sm"
                            >
                              🗑️ 删除
                            </button>
                          </>
