...
export default function RecruitmentManagementPage() {
  ...
  const hasManagementPermission = () => {
    return ['captain', '队长', 'vice_captain', '副队'].includes(userRole)
  }
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex gap-4 pt-4 border-t border-gray-200">
                          ...
                          <button
                            ...
                            className="btn-secondary px-4 py-2 text-red-600 font-medium border border-red-200"
                          >
                            删除
                          </button>
                        </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-4 border-t border-gray-200">
                    ...
                    <button
                      ...
                      className="btn-secondary px-4 py-2 text-red-600 font-medium border border-red-200 flex-1"
                    >
                      删除
                    </button>
                  </div>
