...
DROP TABLE IF EXISTS group_batches;
...
-- 创建索引
CREATE INDEX idx_group_batches_team_id ON group_batches(team_id);
CREATE INDEX idx_group_batches_created_at ON group_batches(created_at DESC);
CREATE INDEX idx_group_results_batch_id ON group_results(batch_id);
CREATE INDEX idx_group_members_result_id ON group_members(result_id);
